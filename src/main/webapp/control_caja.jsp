                                ...
                                <form class="formulario-modal">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="number" name="txtApertura" class="form-control" id="txtApertura" value="0">
                                        </div>
                                        <div class="col-6">
                                            <label>Monto Cierre</label>
                                            <input type="number" name="txtCierre" class="form-control" id="txtNombre" value="0">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
